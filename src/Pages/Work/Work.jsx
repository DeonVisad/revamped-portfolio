    ...
    <div name='work' className='w-full bg-[#adb5bd] flex flex-col items-center pt-36'>
      <div className={appear ? 'm-10 w-3/4 ' : 'hidden'} >
        ...
        <div className={appear ? 'flex flex-col md:flex-row w-full justify-between items-center border-b-[1px] border-zinc-500 my-4 animate__animated animate__slideInUp' : null}>
          ...
          <div className='flex-col justify-center'>
            <div className='flex flex-col'>
              ...
              <div className='flex justify-start md:1/2 my-4'>
          ...
          <a href="javascript:void(0)"><img src={jhrealty} className='md:h-96 md:w-auto h-64 w-96 rounded-xl drop-shadow-sm mb-12 hvr-grow' /></a>
        ...
        <div className={appear ? 'flex flex-col md:flex-row w-full justify-between items-center border-b-[1px] border-zinc-500 my-4 animate__animated animate__slideInUp' : null}>
          ...
          <a href="javascript:void(0)"><img src={portfolio} className='md:h-96 md:w-auto h-64 w-96 rounded-xl drop-shadow-sm mb-12 hvr-grow' /></a>
        ...
        <div className={appear ? 'flex flex-col md:flex-row w-full justify-between items-center border-b-[1px] border-zinc-500 my-4 animate__animated animate__slideInUp' : null}>
          ...
          <a href="javascript:void(0)"><img src={happycow} className='md:h-96 md:w-auto h-64 w-96 rounded-xl drop-shadow-sm mb-12 hvr-grow' /></a>
        ...
        <div className={appear ? 'flex flex-col md:flex-row w-full justify-between items-center border-b-[1px] border-zinc-500 my-4 animate__animated animate__slideInUp' : null}>
          ...
          <a href="javascript:void(0)"><img src={clueo} className='md:h-96 md:w-auto h-64 w-96 rounded-xl drop-shadow-sm mb-12 hvr-grow' /></a>
        ...
        <div className={appear ? 'flex flex-col md:flex-row w-full justify-between items-center border-b-[1px] border-zinc-500 my-4 animate__animated animate__slideInUp' : null}>
          ...
          <a href="javascript:void(0)"><img src={swift} className='md:h-96 md:w-auto h-64 w-96 rounded-xl drop-shadow-sm mb-12 hvr-grow' /></a>
